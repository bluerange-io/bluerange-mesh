...
=== Sensor and Actor Messages
The node includes functionality to send sensor messages and actor messages in a vendor specific manner using a generic packet. This is documented under xref:SensorsAndActors.adoc[Sensors and Actors].
