image:doc/img/logo.png[fruitymesh]
...
Documentation is the key and therefore, you should have a look at the wiki to get you started. This is the same documentation that is also available within the <<doc/_index.adoc#,doc folder>> of this repository:
