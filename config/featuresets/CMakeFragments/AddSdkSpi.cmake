...
elseif (${PLATFORM} STREQUAL "NRF52833")
  file(GLOB   LOCAL_SRC CONFIGURE_DEPENDS  "${PROJECT_SOURCE_DIR}/sdk/sdk16/modules/nrfx/drivers/src/nrfx_spi.c"
                                           "${PROJECT_SOURCE_DIR}/sdk/sdk16/modules/nrfx/drivers/src/prs/nrfx_prs.c"
                                           "${PROJECT_SOURCE_DIR}/sdk/sdk16/integration/nrfx/legacy/nrf_drv_spi.c")
  target_sources(${FEATURE_SET} PRIVATE ${LOCAL_SRC})
