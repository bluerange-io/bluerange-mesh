...
elseif (${PLATFORM} STREQUAL "NRF52833")
  file(GLOB   LOCAL_SRC CONFIGURE_DEPENDS  "${PROJECT_SOURCE_DIR}/sdk/sdk16/modules/nrfx/drivers/src/prs/nrfx_prs.c"
                                           "${PROJECT_SOURCE_DIR}/sdk/sdk16/modules/drivers_nrf/twi_master/nrfx_twi.c"
                                           "${PROJECT_SOURCE_DIR}/sdk/sdk16/integration/nrfx/legacy/nrf_drv_twi.c")
  target_sources(${FEATURE_SET} PRIVATE ${LOCAL_SRC})
  target_include_directories(${FEATURE_SET} PRIVATE "${PROJECT_SOURCE_DIR}/sdk/sdk16/modules/nrfx/drivers/src")
  target_include_directories(${FEATURE_SET} PRIVATE "${PROJECT_SOURCE_DIR}/sdk/sdk16/integration/nrfx/legacy")
