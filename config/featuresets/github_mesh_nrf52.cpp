...
void SetBoardConfiguration_github_mesh_nrf52(BoardConfiguration* c)
{
...
void SetFeaturesetConfiguration_github_mesh_nrf52(ModuleConfiguration* config, void* module)
{
...
void SetFeaturesetConfigurationVendor_github_mesh_nrf52(VendorModuleConfiguration* config, void* module)
{
    
}

u32 InitializeModules_github_mesh_nrf52(bool createModule)
{
    u32 size = 0;
...
DeviceType GetDeviceType_github_mesh_nrf52()
{
    return DeviceType::STATIC;
}

Chipset GetChipset_github_mesh_nrf52()
{
    return Chipset::CHIP_NRF52;
}

FeatureSetGroup GetFeatureSetGroup_github_mesh_nrf52()
{
    return FeatureSetGroup::NRF52_MESH_GITHUB;
}

u32 GetWatchdogTimeout_github_mesh_nrf52()
{
    return 0; //Watchdog disabled by default, activate if desired
}

u32 GetWatchdogTimeoutSafeBoot_github_mesh_nrf52()
{
