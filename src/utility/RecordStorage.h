...
// ############ RECORD IDS 4000 - 7999 #############
// Register Storage
constexpr u16 RECORD_STORAGE_RECORD_ID_INTERNAL_MODULES_REGISTER_ENTRIES_BASE = 4000;
constexpr u16 RECORD_STORAGE_RECORD_ID_INTERNAL_MODULES_REGISTER_ENTRIES_AMOUNT = 2000;
constexpr u16 RECORD_STORAGE_RECORD_ID_INTERNAL_MODULES_REGISTER_ENTRIES_LAST = RECORD_STORAGE_RECORD_ID_INTERNAL_MODULES_REGISTER_ENTRIES_BASE + RECORD_STORAGE_RECORD_ID_INTERNAL_MODULES_REGISTER_ENTRIES_AMOUNT - 1;
constexpr u16 RECORD_STORAGE_RECORD_ID_VENDOR_MODULES_REGISTER_ENTRIES_BASE = 6000;
constexpr u16 RECORD_STORAGE_RECORD_ID_VENDOR_MODULES_REGISTER_ENTRIES_AMOUNT = 2000;
constexpr u16 RECORD_STORAGE_RECORD_ID_VENDOR_MODULES_REGISTER_ENTRIES_LAST = RECORD_STORAGE_RECORD_ID_VENDOR_MODULES_REGISTER_ENTRIES_BASE + RECORD_STORAGE_RECORD_ID_VENDOR_MODULES_REGISTER_ENTRIES_AMOUNT - 1;

// ############ RECORD IDS 8000 - 49999 #############
